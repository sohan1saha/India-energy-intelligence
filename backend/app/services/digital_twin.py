...
class EnergyDigitalTwinService:
    ...
    def _build_graph(self):
        ...
        for edge in self.edges:
            self.graph.add_edge(edge.source_id, edge.target_id, **edge.dict())
    ...
    def get_current_twin_state(self) -> EnergyDigitalTwinState:
        ...
        # India's daily crude consumption ~5.1M bpd = 5.1 Mbbl/day
        days_of_cover = total_spr / 4.12  # ~39.1 / 4.12 = 9.5 days ISPRL buffer
